(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === 'object') exports["Vibrant"] = factory();
    else root["Vibrant"] = factory();
})(window, function() {
        ...
        /* 1 */ /***/ function(module, exports, __webpack_require__) {
            ...
            var Vibrant1 = /** @class */ function() {
                ...
                Vibrant.prototype.getPalette = function() {
                    ...
                    var image1 = new this.opts.ImageClass();
                    return image1.load(this._src).then(function(image) {
                ...
                Vibrant.prototype.getPalettes = function() {
                    ...
                    var image2 = new this.opts.ImageClass();
                    return image2.load(this._src).then(function(image) {
                        return _this._process(image, {
                            generators: names
                        });
                    }).then(function(result) {
 ...
 */ function rgbToHsl(r, g, b) {
        ...
        /* 8 */ /***/ function(module, exports, __webpack_require__) {
            ...
            exports.default = Builder1;
        /***/ },
        /* 9 */ /***/ function(module, exports, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || function() {
                var extendStatics = function(d1, b3) {
            ...
            var BrowserImage1 = /** @class */ function(_super) {
            ...
            var Histogram1 = /** @class */ function() {
                function Histogram(pixels, opts) {
                    ...
                    while(i < n){
                        ...
                        g3 = g3 >> rshift;
                        b4 = b4 >> rshift;
                        var index = getColorIndex(r3, g3, b4);
                        hist[index] += 1;
                        if (r3 > rmax) rmax = r3;
                        if (r3 < rmin) rmin = r3;
                        if (g3 > gmax) gmax = g3;
        ...
        /* 17 */ /***/ function(module, exports, __webpack_require__) {
            ...
            exports.Stage = Stage1;
            var BasicPipeline1 = /** @class */ function() {
                function BasicPipeline() {
                    this.filter = new Stage1(this);
                    this.quantizer = new Stage1(this);
                    this.generator = new Stage1(this);
                }
            ...
            exports.BasicPipeline = BasicPipeline1;
        /***/ }
    ]);
});

//# sourceMappingURL=gallery.56c5600e.js.map
