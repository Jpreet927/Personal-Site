...
})({"kUoll":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "34ad720ded209c43";
...
},{}],"5vSql":[function(require,module,exports) {
var _galleryDataJs = require("../data/GalleryData.js");
...
function renderSoftwareProjects() {
    ...
    for(let key in _galleryDataJs.softwareProjects){
        let project = _galleryDataJs.softwareProjects[key];
        ...
        }).then(projectContainer.addEventListener('mouseenter', ()=>{
...
function renderDesignProjects() {
    ...
    for(let key in _galleryDataJs.designProjects){
        let project = _galleryDataJs.designProjects[key];
        let projectContainer = document.createElement("div");
...
function renderArtwork() {
    ...
    let counter = 0;
    for(let key in _galleryDataJs.artwork){
        let project = _galleryDataJs.artwork[key];
        let projectContainer = document.createElement("div");
        ...
        if (counter % 3 == 0) column1.appendChild(projectContainer);
        else if (counter % 3 == 1) column2.appendChild(projectContainer);
        else column3.appendChild(projectContainer);
        counter++;
        let shadowColour = "";
        Vibrant.from(project.previewImg).getPalette((err, palette)=>{
            let rgb = palette.Muted._rgb;
...
},{"../data/GalleryData.js":"g6bAt"}],"g6bAt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "softwareProjects", ()=>softwareProjects
);
parcelHelpers.export(exports, "designProjects", ()=>designProjects
);
parcelHelpers.export(exports, "artwork", ()=>artwork
);
...
const designProjects = {
    entropy: {
        previewImg: "../images/Gallery Thumbnails/Design/Entropy-Rebrand.png",
    ...
    huntsmen: {
        previewImg: "../images/Gallery Thumbnails/Design/Huntsmen-Proposal.png",
    ...
    rush: {
        previewImg: "../images/Gallery Thumbnails/Design/Rush-Rebrand.png",
...
},{}]},["kUoll","5vSql"], "5vSql", "parcelRequireb8a1")

//# sourceMappingURL=gallery.ed209c43.js.map
